...
# Load a second sample picture and learn how to recognize it.
   manisha_image = face_recognition.load_image_file("MANISHA.jpg")
   manisha_face_encoding = face_recognition.face_encodings(manisha_image)[0]
...
# Create arrays of known face encodings and their names
   ...
   while True:
    ...
    # Display the resulting image
      ...
      cv2.imwrite("/home/manisa/Desktop/data/image.jpg",frame)
